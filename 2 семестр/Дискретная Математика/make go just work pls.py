...
def main():
    # Запрашиваем путь сохранения директории один раз
    ...
    while True:
        ...
        if anti_plag == "" or teacher_comment == "":
            print("Не найдены необходимые строки для антиплагиата или комментария преподавателя.")
            continue
